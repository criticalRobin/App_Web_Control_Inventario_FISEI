...
class LabItem(models.Model):
    ...
    id_laboratory = models.ForeignKey(
        Laboratory, on_delete=models.PROTECT, verbose_name="Laboratorio"
    )
    responsible_user_id = models.ForeignKey(
        User,
        on_delete=models.PROTECT,
...
class ComputerItem(models.Model):
    ...
    id_computer = models.ForeignKey(
        Computer, on_delete=models.PROTECT, verbose_name="Computadora"
    )
